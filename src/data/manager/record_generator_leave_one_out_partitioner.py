...
class LeaveOneOutPartitionerRecordGenerator(BaseRecordGenerator):
    """
    ...
    def __init__(self, \
        ...
        """
        Init a LeaveOneOutPartitionerRecordGenerator object.
        """
        super(LeaveOneOutPartitionerRecordGenerator, self).__init__()
        ...
        self.number_partitions = self.number_records
        self.partition_index = partition_index
        self.to_except = to_except
        # ----
        if partition_index >= self.number_partitions:
            DebuggingHelper.throw_exception(
                f'input argument, '
                f'partition_index|{partition_index}|, is >= self.number_partitions|{self.number_partitions}|')
        # ----
        self.segment_begin_end_index_tuple = (
