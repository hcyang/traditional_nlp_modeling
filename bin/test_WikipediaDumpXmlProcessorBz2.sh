...
export WIKIPEDIA_DUMP_INPUT_PATH=$DATA_ROOT/data_wikipedia/dumps.wikimedia.org_zhwiki_20220401
export WIKIPEDIA_DUMP_XML_FILE_NAME=zhwiki-20220401-pages-articles.xml.bz2
export WIKIPEDIA_DUMP_OUTPUT_PATH=$DATA_ROOT/data_wikipedia/dumps.wikimedia.org_zhwiki_20220401_output
